...
Java_com_dreamsoftware_vaultkeeper_securelib_VaultKeeperNativeSecretsAPI_getMasterPassword(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_dreamsoftware_vaultkeeper_securelib_VaultKeeperNativeSecretsAPI_getMasterSalt(
        JNIEnv* env,
        jobject /* this */) {
